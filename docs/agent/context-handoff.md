...
- Phase 2 has local checkout orchestration, Redis Streams outbox publishing, demo runbook commands, and an opt-in RoadRunner wrapper that remains dependency-gated.
