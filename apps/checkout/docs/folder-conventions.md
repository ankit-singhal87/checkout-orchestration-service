...
The checkout app starts as a Laravel modular monolith with Clean Architecture / hexagonal boundaries. See [docs/human/adr/0006-laravel-clean-boundaries.md](../../../docs/human/adr/0006-laravel-clean-boundaries.md).
